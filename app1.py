...
def create_music_score(best_notes_and_rests, tempo, showScore, tmp_audio_path, soundfont_path):
    ...
    if best_notes_and_rests:
        ...
        if sc.isWellFormedNotation():
            ...
            # Converter MIDI para WAV usando o SoundFont fornecido
...
def main():
    ...
    # Adicionar seção de upload do SoundFont
    ...
    if 'classifier' in st.session_state and 'classes' in st.session_state and soundfont_path is not None:
        ...
        if 'classifier' in st.session_state and 'classes' in st.session_state and soundfont_path is None:
